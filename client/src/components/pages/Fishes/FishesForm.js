...
import { initialValues, validationSchema } from './fishesFormConfig';
import moment from 'moment';
import FileBase from 'react-file-base64';
import './fishes.scss';

const FishesForm = ({ isEditing, editedFish, handleCreate, handleUpdate }) => {
	const { name, desc, dob, age } = editedFish;
	...
	const handleOnSubmit = (fields, { resetForm }) => {
		...
		if (imageFile && imageFile.length > 283733) {
			...
			isEditing
				? handleUpdate(editedFish.id, formData)
